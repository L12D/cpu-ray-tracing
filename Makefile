# Fichiers
TARGET = main
SRCS = src/main.cpp src/utils.cpp src/Camera.cpp src/Scene.cpp src/Sphere.cpp src/Object.cpp src/Shape.cpp src/Application.cpp src/TriangleSet.cpp src/Mesh.cpp
OBJS = $(SRCS:.cpp=.o)
